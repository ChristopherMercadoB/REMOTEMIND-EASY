...
namespace REMOTEMIND_EASY.Presentation.WebApp.Controllers
{
    public class UserResponseController : Controller
    {
        ...
        public UserResponseController(IMapper mapper, IUserResponseService service, IQuestionService questionService, IResponseService userService, IHttpContextAccessor contextAccessor, IResultService resultService)
        {
            _mapper = mapper;
            _service = service;
